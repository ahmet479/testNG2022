...
//    loginPage.password.sendKeys("manager1!");
  ...
  //  Then Kullanıcı ‘wrong password’ mesajını verify eder
    ...
    Thread.sleep(5000);
    Assert.assertFalse(loginPage.errorMassage.getText().contains("manager_password"));
...
*/
  ...
  //      LoginPage loginPage = new LoginPage();
        ...
        loginPage.username.sendKeys(ConfigReader.getProperty("wrong_manager_password"));
