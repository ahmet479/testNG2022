...
*/
    ...
    public void setUp(){
      ...
      //  private isterse
        ...
        //login basarili oldugunu asert edelim
 ...
 //  test method: printRows() ve tum row'lari ile 4. row'daki elementi yazdir
    ...
    public void printRows() throws InterruptedException {
        ...
        for (WebElement herRow: tumRows){
            System.out.println("Satir sayisi:"+ satirNumarasi+"=>" +herRow.getText());
            satirNumarasi++;
    ...
    //test method: printCells() ve table body'deki' cells'lerin toplam sayilarini yazdir ve tum cell'leritek tek yazdir
    @Test
    public void printCells(){
        System.out.println("Print Cells");
        List<WebElement> tumCells = Driver.getDriver().findElements(By.xpath("//tbody//td"));
        // table body'dek' cells'lerin toplam sayilarini yazdir ve tum cell'leri yazdir
        System.out.println("Toplam cell sayis =>  "+tumCells.size());
